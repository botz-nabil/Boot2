...
const starts = async (Devil = new WAConnection()) => {
	...
	console.log(color('[ BOTZNABIL ]', 'cyan'), color('Owner is online now!', 'green'))
	console.log(color('[ BOTZNABIL ]', 'cyan'), color('Welcome back, Owner! Hope you are doing well~', 'green'))
