...
//FAKE NYA BANG
devilfake = 'BotzNabil☕︎'
fake = 'BotzNabil☕︎'
//Ganti No Owner Ok
const Tag = "6281938835391"
...
➸ *Sejak* : ${getTime}`
   ...
   case 'devil': 
               ...
               break           
   case 'wa': 
               sendKontak(from, `6281938835391`, `𝙒𝙝𝙖𝙩𝙨𝘼𝙥𝙥`, 'Sibukk!!')
               break
...
_*✗✗✗*_
*✗⃝⎔ _BOTZ NABIL_*
*➪ https://chat.whatsapp.com/JQeTJZ567LbCFRZ9K17YIs*
*✗⃝🪃*
*❒───⎔✗⃝🪀*
`
...
Devil.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
       ...
       case 'menu':
        ...
        if (!isRegister) return reply(`You are not verified\n\nReply this chat and send bot password\n\nHint : \nPassword contains 4 digit number\nCheck password at: TANYA OWNER`)
               const boy = "6281938835391@s.whatsapp.net"     
...
┃⬡ Contact : @${anuku} 
┃⬡ Instagram :
┃⬡ *https://instagram.com/nab.nab_27*
┃⬡ YouTube : NABNAB 01
┃⬡ Official Group :
┃⬡ *https://chat.whatsapp.com/JQeTJZ567LbCFRZ9K17YIs*
┃⬡ Rest Api :
...
case 'caripesan':  //by ANU TEAM
       ...
       case 'bugreport':
              ...
              Devil.sendMessage('6281938835391@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
              break
       case 'readall':
...
if (args.length < 1) return reply('Jumlahnya?')
	    ...
	    key: {
	    fromMe: false, 
	    participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "6281938835391@s.whatsapp.net" } : {}) 
	    },
                        "message": {
                        "orderMessage": {
						...
						"message": `BOTZNABIL☕︎`,
						"orderTitle": `${fake}`,
						"sellerJid": "6281938835391@s.whatsapp.net",
